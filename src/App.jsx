...
function Buttons({ cubeGroup, rotationGroup }) {
  useControls('Cube', {
    'Left CW': button(() => {
...
function Cube({ cubeGroup, rotationGroup }) {
  ...
  return (
    <>
      ...
      <Buttons cubeGroup={cubeGroup} rotationGroup={rotationGroup} />
    </>
  )
}
...
export default function App() {
  ...
  return (
    <>
      <MoveInput cubeGroup={cubeGroup} rotationGroup={rotationGroup} rotate={rotate} />
      <Canvas camera={{ position: [3, 3, 3] }}>
        <Suspense>
          <Environment preset="forest" />
        </Suspense>

        <Cube cubeGroup={cubeGroup} rotationGroup={rotationGroup} />
